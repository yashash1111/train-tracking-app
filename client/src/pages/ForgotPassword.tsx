        ...
        <div className="flex min-h-[calc(100vh-64px)] items-center justify-center bg-slate-50 dark:bg-slate-900 px-4 py-12">
            <Card className="w-full max-w-md bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 shadow-2xl">
                <CardHeader className="space-y-2 text-center">
                    ...
                    <CardTitle className="text-2xl font-bold font-mono text-yellow-600 dark:text-yellow-400">RESET PASSWORD</CardTitle>
                ...
                {step === 1 ? (
                    ...
                    <form onSubmit={handleResetPassword}>
                        <CardContent className="space-y-4">
                            ...
                            {success && (
                                <div className="rounded-md bg-emerald-950/40 border border-emerald-500/20 p-3.5 text-xs font-mono text-emerald-600 dark:text-emerald-400 flex flex-col gap-2">
                                    <div className="flex items-center gap-2 font-bold">
                                        <CheckCircle2 className="h-4 w-4 shrink-0" /> Security Notice
                                    </div>
                                    <p>An email was dispatched containing your OTP.</p>
                                    <div className="bg-yellow-500 dark:bg-yellow-500/10 border border-yellow-500/20 p-2.5 rounded-lg text-yellow-600 dark:text-yellow-500 font-bold mt-1 text-center text-sm tracking-widest">
                            ...
                            <div className="space-y-2">
                                <label htmlFor="otp" className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-mono">
                                ...
                                <Input
                                    ...
                                    required
                                    className="bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-800 text-yellow-600 dark:text-yellow-400 font-mono tracking-widest text-center text-lg placeholder:text-slate-600 dark:text-slate-600 focus:ring-yellow-500/30 focus:border-yellow-500 h-11"
                                />
                            </div>

                            <div className="space-y-2">
                                <label htmlFor="newPassword" className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-mono">
                            ...
                            <div className="space-y-2">
                                <label htmlFor="confirmPassword" className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-mono">
                        ...
                        <CardFooter className="flex flex-col space-y-4">
                            ...
                            <div className="text-center text-xs font-mono text-slate-500 dark:text-slate-500">
                                Try again?{" "}
                                <button type="button" onClick={() => setStep(1)} className="hover:text-yellow-600 dark:text-yellow-400 underline underline-offset-4">
                                    Request another OTP
                                </button>
                            </div>
                        </CardFooter>
